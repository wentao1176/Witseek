...
def main() -> None:
    ...
    a("Var PathToNormalize")
    a("Var NormalizedPath")
    a("Var PathNormalizeFailed")
    a("Var PathNormalizeLength")
    ...
    # NSIS GetFullPathName clears its output when the final component does not
    # exist. A trailing separator makes the final component empty, allowing
    # us to normalize a proposed install/data directory before it is created.
    for function_prefix in ("", "un."):
        label_prefix = "un_" if function_prefix else ""
        a(f"Function {function_prefix}NormalizeDirectoryPath")
        a(r'  StrCpy $NormalizedPath ""')
        a(r'  StrCpy $PathNormalizeFailed "1"')
        a(f'  StrCmp $PathToNormalize "" {label_prefix}normalize_done')
        a("  ClearErrors")
        a(r'  GetFullPathName $NormalizedPath "$PathToNormalize\"')
        a(f'  IfErrors {label_prefix}normalize_done')
        a(f'  StrCmp $NormalizedPath "" {label_prefix}normalize_done')
        a(r'  StrLen $PathNormalizeLength $NormalizedPath')
        a(f'  StrCmp $PathNormalizeLength 3 {label_prefix}normalize_success')
        a(r'  IntOp $PathNormalizeLength $PathNormalizeLength - 1')
        a(r'  StrCpy $NormalizedPath $NormalizedPath $PathNormalizeLength')
        a(f'{label_prefix}normalize_success:')
        a(r'  StrCpy $PathNormalizeFailed "0"')
        a(f'{label_prefix}normalize_done:')
        a("FunctionEnd")
        a("")
    ...
    a(r'  StrCpy $PathToNormalize "$INSTDIR"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 install_path_invalid')
    a(r'  StrCpy $NormalizedInstallDir "$NormalizedPath"')
    a(r'  StrCpy $INSTDIR "$NormalizedInstallDir"')
    a("  Call ComputeInstallCacheDir")
    a(r'  StrCpy $PathToNormalize "$InstallCacheDir"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 install_path_invalid')
    a(r'  StrCpy $NormalizedCacheDir "$NormalizedPath"')
    a(r'  StrCpy $InstallCacheDir "$NormalizedCacheDir"')
    a(r'  StrCpy $PathToNormalize "$PROFILE\.dsh\witseek"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 install_path_invalid')
    a(r'  StrCpy $ProtectedDshHome "$NormalizedPath"')
    ...
    a(r'  Goto normalize_protected_workspace')
    ...
    a(r'  StrCpy $ProtectedWorkspaceDir "$ProtectedDshHome\workspace"')
    a("normalize_protected_workspace:")
    a(r'  StrCpy $PathToNormalize "$ProtectedWorkspaceDir"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 install_path_invalid')
    a(r'  StrCpy $ProtectedWorkspaceDir "$NormalizedPath"')
    ...
    a(r'  StrCpy $PathToNormalize "$PreviousInstallDir"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 check_install_recovery_marker')
    a(r'  StrCpy $PreviousInstallDir "$NormalizedPath"')
    ...
    a(r'  StrCpy $PathToNormalize "$InstallInProgressDir"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 check_install_dir_empty')
    a(r'  StrCpy $InstallInProgressDir "$NormalizedPath"')
    ...
    a("  Return")
    a("install_path_invalid:")
    a('  MessageBox MB_ICONSTOP|MB_OK "无法解析安装目录、缓存、dsh 数据或工作区路径。请检查路径是否有效，然后重试。原始路径：$PathToNormalize"')
    a("  Abort")
    ...
    a(r'  StrCpy $PathToNormalize "$INSTDIR"')
    a("  Call un.NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 uninstall_path_invalid')
    a(r'  StrCpy $NormalizedInstallDir "$NormalizedPath"')
    a(r'  StrCpy $INSTDIR "$NormalizedInstallDir"')
    a(r'  ${GetParent} "$INSTDIR" $CacheParent')
    a(r'  ${GetFileName} "$INSTDIR" $CacheName')
    ...
    a(r'  Goto normalize_uninstall_dsh_home')
    a("use_default_uninstall_dsh_home:")
    a(r'  StrCpy $ProtectedDshHome "$PROFILE\.dsh\witseek"')
    a("normalize_uninstall_dsh_home:")
    a(r'  StrCpy $PathToNormalize "$ProtectedDshHome"')
    a("  Call un.NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 uninstall_path_invalid')
    a(r'  StrCpy $ProtectedDshHome "$NormalizedPath"')
    ...
    a(r'  Goto normalize_uninstall_workspace')
    a("use_default_uninstall_workspace:")
    a(r'  StrCpy $ProtectedWorkspaceDir "$ProtectedDshHome\workspace"')
    a("normalize_uninstall_workspace:")
    a(r'  StrCpy $PathToNormalize "$ProtectedWorkspaceDir"')
    a("  Call un.NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 uninstall_path_invalid')
    a(r'  StrCpy $ProtectedWorkspaceDir "$NormalizedPath"')
    ...
    a("  Abort")
    a("uninstall_path_invalid:")
    a('  MessageBox MB_ICONSTOP|MB_OK "卸载已停止：无法解析安装目录、缓存、dsh 数据或工作区路径。原始路径：$PathToNormalize。未删除任何文件。"')
    a("  Abort")
    ...
    a(r'  StrCpy $PathToNormalize "$LegacyDefaultInstallDir"')
    a("  Call NormalizeDirectoryPath")
    a(r'  StrCmp $PathNormalizeFailed "0" 0 old_install_cleanup_reparse')
    a(r'  StrCpy $PathCandidate "$NormalizedPath"')
    a("  Call CheckPathReparse")
