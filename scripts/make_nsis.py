...
def main() -> None:
    ...
    for function_prefix in ("", "un."):
        ...
        a(r'  StrCpy $PathCurrent "$NormalizedInstallDir"')
        ...
        a(r'  StrCmp $PathCurrent $NormalizedInstallDir ' + f"{label_prefix}overlap_found")
        a(r'  ${GetParent} "$PathCurrent" $PathParent')
    ...
    a('  MessageBox MB_ICONSTOP|MB_OK "安装目录与 dsh 数据或工作区重叠。为保护配置、凭据和项目文件，请选择其他目录。"')
    a("  Abort")
    ...
    a('  MessageBox MB_ICONSTOP|MB_OK "卸载已停止：安装目录与 dsh 数据或工作区重叠。为保护配置、凭据和项目文件，未删除任何文件。"')
    a("  Abort")
